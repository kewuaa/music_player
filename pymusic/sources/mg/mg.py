...
class Musicer(BaseMusicer):
    ...
    SEARCH_URL = 'https://music.migu.cn/v3/search?page=1&type=song&i={i}&f=html&s={s}&c=001002A&keyword={keyword}&v=3.22.8.2'
    KEY_STR = 'c001002Afhtmlkc7910af6-2669-46cf-8503-482ffd711c79-n41645957215805keyword{keyword}s{s}u{user_agent}/220001v3.22.8.2'
