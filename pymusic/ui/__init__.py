...
class PlayerApp:
    def __init__(self, master):
        ...
        self.play_listbox.configure(selectmode="extended")
        ...
        self.download_listbox.configure(selectmode="extended")
        ...
        self.sources_combobox.configure(keyvariable=self._current_source, width=5)
        self.sources_combobox.pack(side="left")
        self.search_entry = ttk.Entry(self.frame11)
        self.search_entry.configure(width=50)
        ...
        self.frame11.pack(padx=30, pady=36, side="top")
        ...
        self.buttons_frame = ttk.Frame(self.frame10)
        self.frame14 = ttk.Frame(self.buttons_frame)
        ...
        self.frame15 = ttk.Frame(self.buttons_frame)
        ...
        self._current_volume = tk.IntVar(value="88")
        self.volume_scale.configure(from_=0, orient="horizontal", to=100, value=88)
        ...
        self.buttons_frame.configure(height=200, relief="groove", width=200)
        self.buttons_frame.pack(fill="x", padx=30, pady=9, side="top")
        self.frame10.configure(height=200, relief="groove", width=800)
        self.frame10.pack(padx=9, pady=9, side="top")
        ...
        self.mi_command1 = 0
        self.submenu1.add("command", label="vlc路径")
        self.submenu1.entryconfigure(self.mi_command1, command=self._set_vlc_path)
        self.style_submenu = tk.Menu(self.submenu1, tearoff="false")
        self.submenu1.add(tk.CASCADE, menu=self.style_submenu, label="样式")
        self.toplevel.configure(menu=self.menu1)
        self.status_line = ttk.Label(self.toplevel)
        self.status_line.configure(font="{微软雅黑} 12 {}", relief="flat")
        self.status_line.pack(fill="x", side="bottom")
