...
class PlayerApp:
    def __init__(self, master=None):
        ...
        self._play_list = tk.StringVar(value="")
        self.play_listbox.configure(listvariable=self._play_list)
        ...
        self._download_list = tk.StringVar(value="")
        self.download_listbox.configure(listvariable=self._download_list)
